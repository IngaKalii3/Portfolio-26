...
export const SkillsSection = () => {
  return (
    <section id="skills" className="relative py-14 sm:py-16 md:py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5">
          {skillCategories.map((category, index) => (
            <TiltCard
              key={category.title}
              title={category.title.toLowerCase().replace(/\s+/g, "_") + ".ts"}
              delay={index * 0.08}
            >
...
function TiltCard({
  ...
  return (
    <div
      className="animate-fade-up [perspective:1200px]"
