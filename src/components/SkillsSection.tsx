                ...
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.skills.map((skill) => (
                      <span
                        key={skill}
                        className="px-3 py-1.5 bg-background border border-border text-sm font-mono rounded-lg hover:border-primary hover:bg-primary/5 transition-colors cursor-default"
                      >
                        {skill}
                      </span>
                    ))}
