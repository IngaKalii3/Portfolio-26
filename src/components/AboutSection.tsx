        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-fade-up">
            <div className="aspect-[4/5] rounded-2xl overflow-hidden border-2 border-foreground/10 shadow-card">
              <img src={heroImage} alt="Inga Kaltak - AI Consultant" className="w-full h-full object-fill border-fuchsia-400 border-dotted border" />
            </div>
            {/* Decorative elements */}
          ...
          <div className="space-y-8 animate-fade-up stagger-2">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              {highlights.map((item, index) => <div key={item.title} className="p-4 bg-card rounded-xl border transition-colors border-fuchsia-400 border-dotted">
