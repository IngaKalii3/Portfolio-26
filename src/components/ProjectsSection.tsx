...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description:
      "AI-powered career intelligence: upload your résumé + goals and get a weekly forecast of roles, hidden opportunities, rising skills, and companies—sometimes before they post.",
    ...
    <section id="projects" className="relative overflow-hidden py-14 sm:py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div className="md:hidden">
          ...
          >
            {items.map((project) => (
              <div key={project.id} data-card className="snap-start shrink-0 w-[88%] sm:w-[72%]">
          ...
          <div className="flex items-center justify-center gap-2 mt-2">
            {items.map((_, i) => (
              <button
                ...
                onClick={() => scrollToCard(scrollerRef.current, i)}
                className={[
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-6">
          {items.map((project, index) => (
            <div key={project.id} className="animate-fade-up" style={{ animationDelay: `${index * 0.08}s` }}>
              <ProjectCard project={project} reducedMotion={reduced} />
            </div>
          ))}
        </div>
  ...
  return (
    <div className="[perspective:1200px] group">
      <div
        ...
        style={{ transform: pressed ? "rotateX(2deg) rotateY(-4deg)" : undefined }}
