          ...
          >
            ...
            {items.map((project) => (
              <div
                key={project.title}
                data-card
                className="snap-start shrink-0 w-[86%] xs:w-[78%] sm:w-[70%]"
              >
  ...
  return (
    <div className="[perspective:1200px]">
      ...
      >
        ...
        <WindowCard
          title={project.title.toLowerCase().replace(/\s+/g, "-").slice(0, 42) + ".tsx"}
          className="
          ...
          <div className="p-5 sm:p-6 space-y-4">
            <div className="flex items-start justify-between">
              ...
              <div className="flex items-center gap-3">
                {project.kind && (
                  <span className="text-[11px] font-mono px-2 py-1 rounded-full border border-foreground/10 bg-muted/40 text-muted-foreground">
                    {project.kind}
                  </span>
                )}
