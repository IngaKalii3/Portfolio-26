...
const experiences = [
  {
    ...
    highlights: [
      "Built FERPA/Title IX compliance dashboards for school districts, automating policy tracking",
      ...
      "Developed GPT-4 and Claude tools to extract and structure regulatory requirements",
      "Conducted 5 NIST AI RMF feasibility assessments with risk registers",
  ...
  },
  {
    ...
    highlights: [
      "Executed 12+ authorized penetration tests using Metasploit, Burp Suite, and Nmap",
      "Discovered 47 critical vulnerabilities with 48-hour SLA remediation roadmaps",
      "Reduced security incidents by 30% through proactive OSINT reconnaissance",
  ...
  },
  {
    ...
    highlights: [
      "Optimized DoD capital project portfolios achieving 30% improvement in resource utilization",
      "Developed compliance frameworks for Defense Logistics Agency",
      "Designed UX/UI and content strategy for Department of Energy website",
      "Achieved 15% reduction in operational costs through in-depth analysis",
    ],
  },
  {
    ...
    highlights: [
      "Created comprehensive ROI reports guiding budget allocations",
      "Improved operational efficiency by 25% through data analysis",
      "Achieved 30% reduction in data retrieval time through process streamlining",
    ],
  },
];
